        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExtendedWarrantyExpirationDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FloorLevel = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    SvgData = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplianceManuals", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ApplianceManuals_Appliances_ApplianceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompletedOnTime = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplianceManuals_ApplianceId",
                table: "ApplianceManuals",
                column: "ApplianceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskCompletions_MaintenanceTaskId",
